...
$string['calculatedobjectssummary']=
$string['calculatedobjects_help']  =
'A version of calculated questions which allows you to quickly set questions like "<em>How much is {apples} + {oranges}?</em>" They are like numerical questions but with the numbers used selected randomly from a set when the quiz is taken.';
